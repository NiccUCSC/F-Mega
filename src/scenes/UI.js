class UI extends Phaser.Scene {
    ...
    create() {
        ...
        // this.speedometer = this.add.sprite(0, 0, "speedometer").setOrigin(0.5, 1)
        // this.speedometerNeedle = this.add.sprite(0, 0, "speedometerNeedle").setOrigin(0.84, 0.5)
    ...
    update(time, dt) {
        ...
        // this.speedometer.setPosition(wid - 110*unit, hei - 85*unit)
        // this.speedometer.setDisplaySize(200*unit, 120*unit)
